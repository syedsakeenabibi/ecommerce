...
public class Order {
    ...
    private Double totalDiscountedPrice; // Nullable
    ...
    public Order(String orderId, User user, Address shippingAddress, PaymentDetails paymentDetails) {
    ...
    public Order(Long id, String orderId, User user, List<OrderItem> orderItems, LocalDateTime orderDate,
                 ...
                 Double totalDiscountedPrice, Double discount, String orderStatus, int totalItem, LocalDateTime createdAt) {
        this.id = id;
        this.orderId = orderId;
        this.user = user;
